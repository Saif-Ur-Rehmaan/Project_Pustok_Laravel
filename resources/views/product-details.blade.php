                        ...
                        <div class="review-wrapper">
                                    ...
                                    <div class="text">
                                        <div class="row justify-content-between">
                                            ...
                                            @if (Auth::check() && Auth::user()->id == $review->user->id)
                                                <a href="{{ URL('/DeleteReview', Crypt::encrypt($review->id)) }}"
                                                    class="col-auto">
                                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24"
                                                        height="24" viewBox="0,0,300,150">
                                                        <g fill="#c61919" fill-rule="nonzero" stroke="none"
                                        ...
                                        <h6 class="author ">{{ $review->user->displayName }} &nbsp;<span
                                                class="font-weight-400">{{ $review->created_at }}</span>
                                        </h6>
                                        <p>{{ $review->comment }}</p>
                                    </div>
                                </div>
                            ...
                            <div class="rating-row pt-2">
                                ...
                                <span class="rating-widget-block">
                                    <input type="radio" class="StarIcon" value="5" name="star"
                                        id="star5">
                                    <label for="star5"></label>
                                    <input type="radio" class="StarIcon" value="4" name="star"
                                        id="star4">
                                    <label for="star4"></label>
                                    <input type="radio" class="StarIcon" value="3" name="star"
                                        id="star3">
                                    <label for="star3"></label>
                                    <input type="radio" class="StarIcon" value="2" name="star"
                                        id="star2">
                                    <label for="star2"></label>
                                    <input type="radio" class="StarIcon" value="1" name="star"
                                        id="star1">
