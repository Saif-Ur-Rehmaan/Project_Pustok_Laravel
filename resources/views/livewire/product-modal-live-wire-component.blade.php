...
<div class="modal-dialog" role="document">
    @if ($Book)
        ...
        <div class="modal-content">
            <button type="button" class="btn-close" data-bs-dismiss="modal" wire:click='CloseProductModal()'
                    ...
                    <div class="col-lg-7 mt--30 mt-lg--30">
                        <div class="product-details-info pl-lg--30 ">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>Brands: <a href="index#" class="list-value font-weight-bold">
                                        {{ $Book->brand }}</a>
                                </li>
                            ...
                            <div class="compare-wishlist-row ">
                                <a class="add-link ManageWishlistBtn ClickAble {{ Auth::check() &&$Book->wishlists->where('user_id', Auth::user()->id)->where('book_id', $Book->id)->isNotEmpty()? 'bg-success': '' }}"
                                    data-id="{{ $Book->id }}"><i class="fas fa-heart"></i>Add to Wish
                                    List</a>

                                <a href="{{ URL('product-details') }}" class="add-link"><i
