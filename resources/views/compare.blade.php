...
@section('Content')
    <x-Breadcrumb :items="['Home', 'Compare']" />
    <!-- Cart Page Start -->
                            ...
                            <div class="cart-table table-responsive mb--40">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <!-- Product Row -->
                                        <tr>
                                            <td class="pro-remove"><a href="cart#"><i class="far fa-trash-alt"></i></a>
                                            </td>
                                            <td class="pro-thumbnail"><a href="cart#"><img
                                                        src="{{ URL('image/products/product-1.jpg') }}" alt="Product"></a>
                                            </td>
                                            <td class="pro-title"><a href="cart#">Rinosin Glasses</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pro-thumbnail"><a href="cart#"><img
                                                        src="{{ URL('image/products/product-2.jpg') }}" alt="Product"></a>
                                            </td>
                                            <td class="pro-title"><a href="cart#">Rinosin Glasses</a></td>
                                            <td class="pro-price"><span>$395.00</span></td>
                                            <td class="pro-quantity">
                            ...
                            <div class="single-slide">
                                <div class="product-card">
                                    <div class="product-header">
                                        ...
                                        <h3><a href="product-details">Revolutionize Your BOOK With These
                            ...
                            <div class="single-slide">
                                <div class="product-card">
                                    <div class="product-header">
                                        ...
                                        <h3><a href="product-details">Turn Your BOOK Into High Machine</a></h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
