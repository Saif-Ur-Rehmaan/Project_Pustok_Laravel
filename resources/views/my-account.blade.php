                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="myaccount-tab-menu nav" role="tablist">
                                <a href="my-account#dashboad" class="active" data-bs-toggle="tab"><i
                                        class="fas fa-tachometer-alt"></i>
                                    Dashboard</a>
                                <a href="my-account#orders" data-bs-toggle="tab"><i class="fa fa-cart-arrow-down"></i>
                                    Orders</a>
                                <a href="my-account#download" data-bs-toggle="tab"><i class="fas fa-download"></i>
                                    Download</a>
                                <a href="my-account#payment-method" data-bs-toggle="tab"><i
                            ...
                            <div class="tab-content" id="myaccountContent">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Aug 22, 2018</td>
                                                        <td>Yes</td>
                                                        <td><a href="my-account#" class="btn">Download File</a></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Katopeno Altuni</td>
                                                        <td>Sep 12, 2018</td>
                                ...
                                <div class="tab-pane fade" id="address-edit" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <a href="my-account#" class="btn btn--primary"><i class="fa fa-edit"></i>Edit
                                            Address</a>
                                    </div>
                                </div>
                                <!-- Single Tab Content End -->
