     ...
     <!--=================================
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-6">
                            <div class="author-image">
                                <img src="{{URL('image/others/best-seller-author.jpg')}}" alt="">
                            </div>
                        </div>
                ...
                <div class="row space-db--30">
                    <div class="col-lg-8 mb--30">
                        <div class="promo-wrapper promo-type-one">
                            <a href="index#" class="promo-image  promo-overlay bg-image"
                                data-bg="{{URL('image/bg-images/promo-banner-mid.jpg')}}">
                                <!-- <img src="{{URL('image/bg-images/promo-banner-mid.jpg')}}" alt=""> -->
                            </a>
                            <div class="promo-text">
                                <div class="promo-text-inner">
                                    <h2>Buy 3. Get Free 1.</h2>
                                    <h3>50% off for selected products in Pustok.</h3>
                                    <a href="index#" class="btn btn-outlined--red-faded">See More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 mb--30">
                        <div class="promo-wrapper promo-type-two ">
                            <a href="index#" class="promo-image promo-overlay bg-image"
                                data-bg="{{URL('image/bg-images/promo-banner-small.jpg')}}">
                                <!-- <img src="{{URL('image/bg-images/promo-banner-small.jpg')}}" alt=""> -->
                            </a>
                            <div class="promo-text">
                                <div class="promo-text-inner">
                                    ...
                                    <h2>Praise for <br>
                                        The Night Child</h2>
                                    <a href="index#" class="btn btn-outlined--primary">Buy Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section-margin">
            <div class="promo-wrapper promo-type-three">
                <a href="index#" class="promo-image promo-overlay bg-image" data-bg="{{URL('image/bg-images/promo-banner-full.jpg')}}">
                </a>
                        ...
                        <div class="row w-100">
                            <div class="col-lg-7">
                                ...
                                <h3>Cover up front of book and
                                    leave summary</h3>
                                <a href="index#" class="btn btn--yellow">$78.09 - Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
