<footer class="site-footer">
            ...
            <div class=" col-xl-3 col-lg-4 col-sm-6">
                <div class="single-footer pb--40">
                    <div class="brand-footer footer-title">
                        <img src="{{URL('image/logo--footer.png')}}" alt="">
                    </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <a href="index#" class="payment-block">
                <img src="{{URL('image/icon/payment.png')}}" alt="">
            </a>
            <p class="copyright-text">Copyright © 2022 <a href="index#" class="author">Pustok</a>. All Right Reserved.
                <br>
                Design By Pustok</p>
        </div>
    </div>
